...
## 1 Fork 代码
1. 访问 https://github.com/gotomicro/ego-component
...
```bash
git clone https://github.com/gotomicro/ego-component.git
cd ego
git remote add upstream 'git@github.com:<your github username>/ego-component.git'
```
...
## 6 提交 PR
访问 https://github.com/gotomicro/ego-component, 
