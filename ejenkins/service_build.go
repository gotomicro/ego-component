...
func (b *Build) GetInjectedEnvVars() (map[string]string, error) {
	...
	_, err := b.Jenkins.Requester.GetJSON(endpoint, nil, &envVars, nil)
	if err != nil {
...
func (b *Build) GetResultSet() (*TestResult, error) {
	...
	_, err := b.Jenkins.Requester.GetJSON(url, nil, &report, nil)
	if err != nil {
		return nil, err
	}
...
func (b *Build) IsGood() bool {
	return !b.IsRunning() && b.Raw.Result == StatusSuccess
}
...
func (b *Build) SetDescription(description string) error {
	_, err := b.Jenkins.Requester.Post(b.Base+"/submitDescription", map[string]string{"description": description}, nil, nil)
	return err
}
...
func (b *Build) Poll(options ...interface{}) (int, error) {
	...
	response, err := b.Jenkins.Requester.GetJSON(b.Base, nil, b.Raw, qr)
	if err != nil {
		return 0, err
	}
